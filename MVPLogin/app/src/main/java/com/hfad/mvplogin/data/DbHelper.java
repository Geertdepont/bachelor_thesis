...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public static final String USER_COLUMN_EMAIL = "usr_email";
    public static final String USER_COLUMN_PASSWORD = "usr_password";
    ...
    protected List<User> getAllUsers() throws Resources.NotFoundException, NullPointerException {
        ...
        try {
            ...
            if (cursor.getCount() > 0) {
                ...
                throw new Resources.NotFoundException("There are no users");
            }
    ...
    protected User getUser(String email) throws Resources.NotFoundException, NullPointerException {
        Cursor cursor = null;
        try {
            SQLiteDatabase db = this.getReadableDatabase();
            cursor = db.rawQuery(
            ...
            if (cursor.getCount() > 0) {
                ...
                throw new Resources.NotFoundException("User with email " + email + " does not exists");
            }
        } catch (NullPointerException e) {
            e.printStackTrace();
            throw e;
