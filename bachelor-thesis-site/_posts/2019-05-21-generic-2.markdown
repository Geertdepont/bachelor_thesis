...
<h3>Example</h3>
We created a simple [Boss Application][boss-application] which retrieves users from a dummy API. 
...
Check out the [Github page][boss-application] to view the complete repository.
